...
<html lang="en">
    ...
    <body>
        ...
        <form id="signInForm" role="form" method='POST' action="<c:url value='j_spring_security_check' />">
            <sec:csrfInput /> <!-- u need to a add that for cross site request protection , if u dont
                              want it then leave it alone config will take care of that -->
...
<!-- u cannot change the two input controls or the button !-->
    </body>
</html>